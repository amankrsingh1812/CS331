...
3. To run on custom input use the command in prolog console: "sqrt(X,Accuracy)." where X is input Number and Accuracy is largest value of error allowed. X should be greater than equal to 0 and Accuracy should be strictly greater than 0.
